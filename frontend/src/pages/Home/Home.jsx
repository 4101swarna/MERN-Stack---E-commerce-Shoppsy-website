    ...
    <div className="">
      <div className="py-2 px-2 md:py-4 bg-white">
        ...
        <p className="text-xs md:text-lg text-center text-gray-700 font-semibold tracking-wide">
          Discover our top picks of the time, handpicked just for you!
        </p>
      </div>
      <div
        className={`${
      ...
      >
        ...
        {isLoading ? (
          ...
          <>
            {/* Main Heading */}
            <div className="py-3 sm:mt-12 sm:py-6 bg-gray">
              <div className="mb-2 sm:mb-4 flex justify-center gap-5 items-center">
                ...
                <Link
                  to="/shop"
                  className="px-3 py-1 text-xs sm:text-md sm:px-5 bg-blue-600 text-white font-semibold rounded-full hover:bg-pink-700 transition duration-200"
                >
                  Shop Now
                </Link>
              </div>
